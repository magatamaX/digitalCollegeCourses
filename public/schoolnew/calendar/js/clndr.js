...
(function (factory) {
    ...
    var clndrTemplate =
        "<div class='clndr-controls'>" +
            "<h2 class='month'><%= month %> <%= year %></h2>" +
            "<ul class='clndr-control-button clearfix'>" +
                "<li class='clndr-previous-button'><a href='javascript:void(0)'><i class='fa fa-angle-double-left' aria-hidden='true'></i> 前の月</a></li>" +
                "<li class='clndr-next-button'><a href='javascript:void(0)'>次の月 <i class='fa fa-angle-double-right' aria-hidden='true'></i></a></li>" +
            "</ul>" +
        "</div>" +
        "<div class='clndr-table' border='0' cellspacing='0' cellpadding='0'>" +
            "<div class='row'>" +
                ...
                "<% for(var i = 0; i < daysOfTheWeek.length; i++) { %>" +
                    "<div class='cell header-day'><%= daysOfTheWeek[i] %></div>" +
                "<% } %>" +
                "</div>" +
            "</div>" +
